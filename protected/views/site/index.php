...
<span>$evento</span> <span>=</span>
    <span>array</span><span>(</span><span>'data'</span> <span>=></span><span style="font-size:19px; font-weight:bold;">'05/11/2011'</span><span>,</span>
        ...
        <a href="#" style="float:right;"><img src="img/bt-inscreva-se.png" alt="Cadastre-se" width="165" height="47" border="0" /></a>        </div>
<!-- cadastre-se -->

<!-- carrosel -->
<div id="palestrantes">
   <a href="#" class="prev">X</a>
      <div id="scroller">
        <ul>
          ...
          <li>
           ...
           <li>
              <div class="palestrante">
              <img src="img/palestrante-sem-foto.png" style="float:left; padding-right:10px;" />
                <h3>André Pfeiffer</h3>
                <p>Certificação e Software Livre</p>
              </div>
          </li>

         </ul>
        </div>
         <a href="#" class="next">X</a>
</div>
<!-- carrosel -->
...
<div class="box-logos-patrocinio"><a href="#"><img src="img/logo-php-rio.gif" alt="Php Rio" width="115" height="79" border="0"   /></a></div>
<div class="box-logos-patrocinio"><a href="#"><img src="img/logo-cefet.gif" alt="Cefet" width="115" height="79" border="0"   /></a></div>
<div class="box-logos-patrocinio"><a href="#"><img src="img/logo-hotel-urbano.gif" alt="Hotel Urbano" width="115" height="79" border="0"   /></a></div>
<div class="box-logos-patrocinio"><a href="#"><img src="img/patrocine-aqui.jpg" alt="Php Rio" width="115" height="79" border="0"   /></a></div>
<div class="box-logos-patrocinio"><a href="#"><img src="img/patrocine-aqui.jpg" alt="Php Rio" width="115" height="79" border="0"   /></a></div>
<div class="box-logos-patrocinio"><a href="#"><img src="img/patrocine-aqui.jpg" alt="Php Rio" width="115" height="79" border="0"   /></a></div>
</div>
</div>
