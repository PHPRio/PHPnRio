...
class AttendeeCalculator extends CBehavior {
	...
	public function beforeAction() {
		$this->owner->total_attendees = array(
			...
			'confirmed_attendees'	=> Attendee::model()->with('transaction')->count('transaction.code != :code', array(':code' => Transaction::CODE_FREE_TICKETS)),
			'free_attendees'		=> Attendee::model()->with('transaction')->count('transaction.code = :code', array(':code' => Transaction::CODE_FREE_TICKETS)),
