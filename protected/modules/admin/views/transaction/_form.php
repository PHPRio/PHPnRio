<div class="form">
	...
	?>
	<p class="note">Subir um XML com novos registros enviará um email para cada um dos novos inscritos, informando sobre a página de finalização das inscrições.</p>
	<? echo CHtml::endForm(); ?>
</div>